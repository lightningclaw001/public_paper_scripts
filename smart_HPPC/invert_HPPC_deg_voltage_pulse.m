...
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\voltage_pulses_'+ ... 
...
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\R_f_c_only\voltage_pulses_'+ ...
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\R_f_a_only\voltage_pulses_'+ ...
%             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + 'V\' + ...
%             'Rf_'+ sprintf('%.3f',Rf(i2)) + '\sim_output\output_data.mat');
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_lyte_only_dilute\voltage_pulses_'+ ... 
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_lyte_only\voltage_pulses_'+ ... 
%          load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_lyte_only_dilute\voltage_pulses_'+ ... 
%         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_lyte_only\voltage_pulses_'+ ... 
%             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + 'V\clyte_'+ sprintf('%.1f',clyte(i2)) + ...
%             '\sim_output\output_data.mat');
%           load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_tilde_c_only\test\voltage_pulses_'+ ...
        load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\c_tilde_c_only\voltage_pulses_'+ ...
            ...
            '\sim_output\output_data.mat');
%          load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_full_cell\all_deg_sphere\voltage_pulses_'+ ...
%             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + ...
%             'V\ctilde_' + sprintf('%.4f',ctilde(i2))+'_clyte_' + ...
%             sprintf('%.1f',clyte(i2)) + '_Rf_'+ sprintf('%.4f',Rf(i2)) ...
%             + '\sim_output\output_data.mat');
        ...
        for i3 = 1:N    
            ...
            if i2 == 1
                ...
                %after the charge/discharge pulse
                paramsOptim(i3).charge_rlx(i1) = mures_charge_rlx(1); %ref voltage
                paramsOptim(i3).discharge_rlx(i1) = mures_discharge_rlx(1); % ref votlage
                paramsOptim(i3).charge_rlx_c(i1) = mures_charge_rlx_c(1); %ref voltage
                paramsOptim(i3).discharge_rlx_c(i1) = mures_discharge_rlx_c(1); % ref votlage
                paramsOptim(i3).charge_rlx_a(i1) = mures_charge_rlx_a(1); %ref voltage
                paramsOptim(i3).discharge_rlx_a(i1) = mures_discharge_rlx_a(1); % ref votlage              
            end
            ...
            dataRef(i3).charge_rlx(i1,i2) = mures_charge_rlx(1)-mures_charge_pulse(end); %this is voltage difference for relax
            %this value should be negative because we are relaxing
            dataRef(i3).discharge_rlx(i1,i2) = mures_discharge_rlx(1)-mures_discharge_pulse(end);
...
% function [paramsOptim, dataRef, params_nondim, params] = loadDataMPETSimsHalfCell()
% %%% load data from single particle simulations
% % returns: loaded current and voltage data for current pulses and
% % relaxation segments
% 
...
% 
% params_nondim.rescale_c = L_c * (1-poros_c)*P_L_c*mean(3./particle_sizes);
% %for full cell % for half cell
% params_nondim.rescale_a = 1;
...
%         % load data for all sols for i2-th state of degradation x is time y
%         % is state variable
% %         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_half_cell\c_lyte_only\voltage_pulses_'+ ...
% %             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + 'V\clyte_' + ...
% %             sprintf('%.1f',clyte(i2))+ '\sim_output\output_data.mat');       
% %         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_half_cell\R_f_only\voltage_pulses_'+ ...
% %             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + 'V\' + ...
% %             'Rf_'+ sprintf('%.3f',Rf(i2)) + ...
% %             '\sim_output\output_data.mat');
% %         load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_half_cell\c_tilde_only\voltage_pulses_'+ ...
% %             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + ...
% %             'V\ctilde_' + sprintf('%.4f',ctilde(i2)) + ...
% %             '\sim_output\output_data.mat');
%          load('C:\Users\ChemeGrad2019\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\dezhuang\projects\hppc_data\MPET_half_cell\voltage_pulses_'+ ...
%             string(paramsOptim(1).voltage_pulse_range(i1)*1e-3) + ...
%             'V\ctilde_' + sprintf('%.4f',ctilde(i2))+'_clyte_' + ...
%             sprintf('%.1f',clyte(i2)) + '_Rf_'+ sprintf('%.3f',Rf(i2)) ...
%             + '\sim_output\output_data.mat');
...
%             
%             mures_charge_pulse_c = -mean(phi_bulk_c(idxCharge,:),2) + mean(phi_lyte_c(idxCharge,:),2);
%             mures_charge_pulse_a = phi_cell(idxCharge) - 0.5*(phi_lyteGP_L(idxCharge) + phi_lyte_s(idxCharge,1));
%             %for concentrated model
%             if params_nondim.electrolyte == "SM"
%                 mures_charge_pulse_c = -mean(phi_bulk_c(idxCharge,:),2) + mean(phi_lyte_c(idxCharge,:),2) - log(a_l(mean(c_lyte_c(idxCharge,:),2), params_nondim));
%                 mures_charge_pulse_a = phi_cell(idxCharge) - 0.5*(phi_lyteGP_L(idxCharge) + phi_lyte_s(idxCharge,1));
...
%             % for dilute model
%             mures_discharge_pulse_c = -mean(phi_bulk_c(idxDischarge,:),2) + mean(phi_lyte_c(idxDischarge,:),2);
%             mures_discharge_pulse_a = phi_cell(idxDischarge) - 0.5*(phi_lyteGP_L(idxDischarge) + phi_lyte_s(idxDischarge,1));
%             % for concentrated model
%             if params_nondim.electrolyte == "SM"
%                 mures_discharge_pulse_c = -mean(phi_bulk_c(idxDischarge,:),2) + mean(phi_lyte_c(idxDischarge,:),2) - log(a_l(mean(c_lyte_c(idxDischarge,:),2), params_nondim));
%                 mures_discharge_pulse_a = phi_cell(idxDischarge) - 0.5*(phi_lyteGP_L(idxDischarge) + phi_lyte_s(idxDischarge,1));
...
% [paramsOptim, dataRef, params_nondim, params] = loadDataMPETSims()
%well as a particle size distribution
[paramsOptim, dataRef, params_nondim, params] = loadDataMPETSimsFullCell()

% [paramsOptim, dataRef, params_nondim, params] = loadDataMPETSimsHalfCell()
...
%         saveas(gcf,'full_cell_pulse_fit_' + params_nondim.norm + '_' + params_nondim.optimize + '_' + params_nondim.norm_type +'.png')
        save('full_cell_pulse_fit_c_tilde_c_' + params_nondim.norm + '_' + ...
            params_nondim.optimize + '_' + params_nondim.norm_type + '_' +...
            params_nondim.approx + '.mat')


%         figure(2) plot(linspace(1,0.9,10), 'k--', 'DisplayName',
%         'Reference Solution') hold on plot(zRelax, 'DisplayName', 'Fitted
%         Solution') xlabel('State') ylabel('c_{tilde} (M)') legend()
%         saveas(gcf,'relax_fit_' + params_nondim.norm + '_' +
%         params_nondim.optimize + '_' + params_nondim.norm_type +'.png')
        end
...
function out = solve_i_half_cell(delta_V, c_charge_v_c, R_f_c, c_tilde_c, c_lyte, ...
            mures_charge_vd_c, params_nondim, k0_c, lambda_c, ...
            mures_charge_vd_a)
%takes input values and calculates exact value for deltaV for a half cell
%with a Li reference electrode
i_a = 2*sqrt(a_l(c_lyte, params_nondim))*sinh(mures_charge_vd_a/2);
params_nondim.electrode = "c"; muc = mu_c(c_charge_v_c, params_nondim);
i_c = R(c_charge_v_c, k0_c, lambda_c, c_tilde_c, R_f_c, c_lyte, muc, mures_charge_vd_c + delta_V, params_nondim);
out = i_a - params_nondim.ca_ratio*i_c;
end
...
for i1 = 1:V
    for i3 = 1:6
        ...
        if params_nondim.approx == "linear"
            params_nondim.electrode = "c";
            W_charge_c_bar = W(c_charge_v_c, R_f_c, c_tilde_c, c_lyte, ...
                mures_charge_vd_c, params_nondim, k0_c, lambda_c);
            %shoot, we need to get the anode SOC too
            params_nondim.electrode = "a";
            W_charge_a_bar = W(c_charge_v_a, R_f_a, c_tilde_a, c_lyte, ...
                mures_charge_vd_a, params_nondim, k0_a, lambda_a);
            diratio = dideta_ratio(c_charge_v_c, c_charge_v_a, k0_c, k0_a, ...
                lambda_c, lambda_a, mures_charge_vd_c, mures_charge_vd_a, params_nondim);
...
%         % option 2: solve for i_a = i_c for delta mures
            delta_V = fsolve(@(delta_V) solve_i_full(delta_V, c_charge_v_c, ...
                R_f_c, c_tilde_c, c_lyte, ...
                mures_charge_vd_c + log(a_l(c_lyte, params_nondim)), params_nondim, k0_c, lambda_c, ...
                c_charge_v_a, R_f_a, c_tilde_a, mures_charge_vd_a + log(a_l(c_lyte, params_nondim)), k0_a, ...
                lambda_a), 0, options);
            params_nondim.electrode = "a"; mua = mu_c(c_charge_v_a, params_nondim);
            i_a = R(c_charge_v_a, k0_a, lambda_a, c_tilde_a, R_f_a, c_lyte, mua, mures_charge_vd_a + log(a_l(c_lyte, params_nondim)) + delta_V, params_nondim);
            i_a_ref = R(c_charge_v_a, k0_a, lambda_a, 1, 0, 1, mua, mures_charge_vd_a, params_nondim);
    
            W_charge = i_a/i_a_ref / params_nondim.W_ref_charge(i1, i3);
        end
...
%             /(params_nondim.rescale_a*dideta_a+W_ca*params_nondim.rescale_c*diratio*dideta_a);
        ...
        charge_test = W_charge.*transpose(rxn_charge);
    ...
    %         % option 1: calculate W with linear approximation
            params_nondim.electrode = "c";
            W_discharge_c_bar = W(c_discharge_v_c, R_f_c, c_tilde_c, c_lyte, ...
                mures_discharge_vd_c, params_nondim, k0_c, lambda_c);
            %shoot, we need to get the anode SOC too
            params_nondim.electrode = "a";
            W_discharge_a_bar = W(c_discharge_v_a, R_f_a, c_tilde_a, c_lyte, ...
                mures_discharge_vd_a, params_nondim, k0_a, lambda_a);
            diratio = dideta_ratio(c_charge_v_c, c_charge_v_a, k0_c, k0_a, ...
                lambda_c, lambda_a, mures_discharge_vd_c, mures_discharge_vd_a, params_nondim);
            %linearized solution. can also solve directly
             W_discharge = (W_discharge_c_bar + W_discharge_a_bar.*params_nondim.ca_ratio.*diratio)./ ...
                 (1+params_nondim.ca_ratio.*diratio);
        elseif params_nondim.approx == "exact"

    %        % option 2: solve for i_a = i_c for delta mures. this options is a
    %       little bit more accurate for dilute solution
            delta_V = fsolve(@(delta_V) solve_i_full(delta_V, c_discharge_v_c, ...
                R_f_c, c_tilde_c, c_lyte, ...
                mures_discharge_vd_c + log(a_l(c_lyte, params_nondim)), params_nondim, k0_c, lambda_c, ...
                c_discharge_v_a, R_f_a, c_tilde_a, mures_discharge_vd_a + log(a_l(c_lyte, params_nondim)), k0_a, ...
                lambda_a), 0, options);

            params_nondim.electrode = "a"; mua = mu_c(c_discharge_v_a, params_nondim);
            i_a = R(c_discharge_v_a, k0_a, lambda_a, c_tilde_a, R_f_a, c_lyte, mua, mures_discharge_vd_a + log(a_l(c_lyte, params_nondim)) + delta_V, params_nondim);
            i_a_ref = R(c_discharge_v_a, k0_a, lambda_a, 1, 0, 1, mua, mures_discharge_vd_a, params_nondim);
            W_discharge = i_a/i_a_ref / params_nondim.W_ref_discharge(i1, i3);
...
%             /(params_nondim.rescale_a*dideta_a+W_ca*params_nondim.rescale_c*diratio*dideta_a);
        ...
        % pull/calculate test and true charge rate
        discharge_test = W_discharge.*transpose(rxn_discharge);
...
function [res, fig] = integratedAreaAllSOCHalfCell(z, d, paramsOptim, params_nondim, ...
    dataRef, flagPlot)
% d is the degraded state of charge freq is 1/(t-t0) x is the integrated
% area freq = params.freq;
...
for i1 = 1:V
    ...
    %    c_charge_v_a = paramsOptim(i3).c_charge_a(i1, 1);
        ...
        if params_nondim.approx == "linear"
            ...
            %shoot, we need to get the anode SOC too
    %        params_nondim.electrode = "a";
            W_charge_a_bar = W_ref_anode(c_lyte, mures_charge_vd_a, params_nondim);
            diratio = dideta_ratio_half_cell(c_charge_v_c, k0_c, ...
                lambda_c, mures_charge_vd_c, mures_charge_vd_a, params_nondim);
%             %linearized solution. can also solve directly
             W_charge = (W_charge_c_bar + W_charge_a_bar.*params_nondim.ca_ratio.*diratio)./ ...
                 (1+params_nondim.ca_ratio.*diratio);
        elseif params_nondim.approx == "exact"
%         % option 2: solve for i_a = i_c for delta mures
            muc = mu_c(c_charge_v_c, params_nondim);
            delta_V = fsolve(@(delta_V) solve_i_half_cell(delta_V, c_charge_v_c, ...
                R_f_c, c_tilde_c, c_lyte, ...
                mures_charge_vd_c + log(a_l(c_lyte, params_nondim)), params_nondim, k0_c, lambda_c, ...
                mures_charge_vd_a + log(a_l(c_lyte, params_nondim))), 0, options);

            W_charge = sqrt(a_l(c_lyte,params_nondim))* ...
                sinh(mures_charge_vd_a + log(a_l(c_lyte, params_nondim)) + delta_V)/sinh(mures_charge_vd_a);
        end
...
%             /(params_nondim.rescale_a*dideta_a+W_ca*params_nondim.rescale_c*diratio*dideta_a);
    ...
    %         % option 1: calculate W with linear approximation
            ...
            %shoot, we need to get the anode SOC too
    %        params_nondim.electrode = "a";
            W_discharge_a_bar = W_ref_anode(c_lyte, mures_charge_vd_a, params_nondim);
            diratio = dideta_ratio_half_cell(c_discharge_v_c, k0_c, ...
                lambda_c, mures_discharge_vd_c, mures_discharge_vd_a, params_nondim);
%             %linearized solution. can also solve directly
             W_discharge = (W_discharge_c_bar + W_discharge_a_bar.*params_nondim.ca_ratio.*diratio)./ ...
                 (1+params_nondim.ca_ratio.*diratio);
    ...
    %        % option 2: solve for i_a = i_c for delta mures. this options is a
    %       little bit more accurate for dilute solution
            muc = mu_c(c_discharge_v_c, params_nondim);
            delta_V = fsolve(@(delta_V) solve_i_half_cell(delta_V, c_discharge_v_c, ...
                R_f_c, c_tilde_c, c_lyte, ...
                mures_discharge_vd_c + log(a_l(c_lyte, params_nondim)), params_nondim, k0_c, lambda_c, ...
                mures_discharge_vd_a + log(a_l(c_lyte, params_nondim))), 0, options);

            W_discharge = sqrt(a_l(c_lyte,params_nondim))* ...
                sinh(mures_discharge_vd_a + log(a_l(c_lyte, params_nondim)) + delta_V)/sinh(mures_discharge_vd_a);
...
W_ref_charge = zeros(V, 6);
W_ref_discharge = zeros(V, 6);
...
for i1 = 1:V
    for i3 = 1:6
        ...
        delta_V = fsolve(@(delta_V) solve_i_full(delta_V, c_charge_v_c, ...
            0, 1, 1, ...
            mures_charge_vd_c, params_nondim, 10, 3.78, ...
            c_charge_v_a, 0, 1, mures_charge_vd_a, 0.2, ...
            5), 0, options);
        params_nondim.electrode = "a"; mua = mu_c(c_charge_v_a, params_nondim);
        i_a = R(c_charge_v_a, 0.2, 5, 1, 0, 1, mua, mures_charge_vd_a + delta_V, params_nondim);
        i_a_ref = R(c_charge_v_a, 0.2, 5, 1, 0, 1, mua, mures_charge_vd_a, params_nondim);

        W_ref_charge(i1, i3) = i_a/i_a_ref;

            %       little bit more accurate for dilute solution
        delta_V = fsolve(@(delta_V) solve_i_full(delta_V, c_discharge_v_c, ...
            0, 1, 1, ...
            mures_discharge_vd_c, params_nondim, 10, 3.78, ...
            c_discharge_v_a, 0, 1, mures_discharge_vd_a, 0.2, 5), 0, options);

        params_nondim.electrode = "a"; mua = mu_c(c_discharge_v_a, params_nondim);
        i_a = R(c_discharge_v_a, 0.2, 5, 1, 0, 1, mua, mures_discharge_vd_a + delta_V, params_nondim);
        i_a_ref = R(c_discharge_v_a, 0.2, 5, 1, 0, 1, mua, mures_discharge_vd_a, params_nondim);
        W_ref_discharge(i1, i3) = i_a/i_a_ref;


    end
end

params_nondim.W_ref_charge = W_ref_charge;
params_nondim.W_ref_discharge = W_ref_discharge;
...
function [z] = optimizePulseHalfCell(z0, paramsOptim, d, ...
    params_nondim, dataRef)
% [Z] = OPTIMIZEPULSE(X0,OPTIMPARAMS,D,PARAMS_NONDIM,DATAREF) optimizes the
% values of (R_f, c_tilde, c_lyte) for a given pulsing strategy.
% 
...
% define inequality constraints range: R_f_c >=0, 0.5 <= ctilde <= 1, 0.5 <=
% ctilde <= 1, R_f >=0, 0 <= c_lyte <=1
A = -eye(3); A(4,2) = 1; A(5,3) = 1; A(6,1) = 1;
b = [0; -0.5; -0.55; 1; 1; 10];
...
switch params_nondim.optimize
    case "together_half_cell"
        % if we choose to optimize over all at the same time, we redefine
        % objective function
        objFun = @(z) integratedAreaAllSOCHalfCell(z, d, paramsOptim, params_nondim, ...
            dataRef, false);
end
...
switch params_nondim.optimize
    case "together_half_cell"
        [objVal, fig] = integratedAreaAllSOCHalfCell(z, d, paramsOptim, params_nondim, ...
            dataRef, false);
end
